...
public class DrinkOrdererTest {
    ...
    public void sendingTeaMessageWithoutSugar() {
        Assert.assertEquals("T::", drinkOrderer.createCommand(Drink.TEA,0));
    }

    @Test
    public void sendingCoffeeMessageWithoutSugar() {
        Assert.assertEquals("C::", drinkOrderer.createCommand(Drink.COFFEE,0));
    }

    @Test
    public void sendingChocolateMessageWithoutSugar() {
        Assert.assertEquals("H::", drinkOrderer.createCommand(Drink.CHOCOLATE,0));
    }

    @Test
    public void sendingTeaMessageWithOneSugar() {
        Assert.assertEquals("T:1:0", drinkOrderer.createCommand(Drink.TEA,1));
    }

    @Test
    public void sendingChocolateWithTwoSugar() {
        Assert.assertEquals("H:2:0", drinkOrderer.createCommand(Drink.CHOCOLATE,2));
    }
